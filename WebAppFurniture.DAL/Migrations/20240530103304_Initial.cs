...
namespace WebAppFurniture.DAL.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParameterProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParameterProducts_Parameters_ParameterId",
                        column: x => x.ParameterId,
                        principalTable: "Parameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParameterProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParameterProducts_ParameterId",
                table: "ParameterProducts",
                column: "ParameterId");

            migrationBuilder.CreateIndex(
                name: "IX_ParameterProducts_ProductId",
                table: "ParameterProducts",
                column: "ProductId");
